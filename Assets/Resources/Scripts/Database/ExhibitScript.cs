...
public class ExhibitScript : MonoBehaviour
{
    ...
    public GameObject exhibitManager;
    ...
    private void Start()
    {
        ...
        audioManager = exhibitManager.GetComponent<AudioManager>();
    ...
    {
        string canvasName = gameObject.name; 
        audioManager.PlayAudioForCanvas(canvasName);  
    }
